        ...
        <div id='html' className='app'>
            <nav style={{display: navOn ? 'block' : 'none'}}>
                <ul className='navOptions'>
                    <svg id='logo1' data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 386.93 279.33"
                         onClick={scrollToTop}>
                    ...
                    <li onClick={() => {
                        scroll.scrollTo($('#web').position().top)
                    }}>Web
                    </li>
                    <li onClick={() => {
                        scroll.scrollTo($('#unity').position().top)
                    }}>Unity
                    </li>
                </ul>
            </nav>
